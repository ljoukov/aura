...
const AuraDemo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col p-4">
      <div className="w-full max-w-sm mx-auto flex flex-col gap-4 flex-1 justify-center">
      ...
      {/* Time Slider Controller - Fixed at Bottom */}
      <div className="w-full max-w-sm mx-auto px-2 pb-safe">
        <div className="mb-2">
